...
WINDOW* init_ncurses() {
    ...
    init_pair(ROAD_COL, COLOR_WHITE, COLOR_BLACK);
    init_pair(ROAD_RED_COL, COLOR_RED, COLOR_BLACK);
    init_pair(ROAD_GREEN_COL, COLOR_GREEN, COLOR_BLACK);
    init_pair(ROAD_YELLOW_COL, COLOR_YELLOW, COLOR_BLACK);
